"""Add camp_id column to groups table

Revision ID: a7212a67e2b0
Revises: 
Create Date: 2024-05-12 03:53:10.137255
...
def upgrade():
    ...
    op.add_column('groups', sa.Column('camp_id', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    sa.Column('password', sa.VARCHAR(length=110), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('target_id_seq'::regclass)"), autoincrement=True, nullable=False),
